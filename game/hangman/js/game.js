...
box.type = "textbox";
box.className = "guess gameControl";
box.size = 1;

var playerDropdown = null;
(function() {
    playerDropdown = document.createElement("select");
    playerDropdown.className = "gameControl";
...
function CanvasDisplay(parent, level) {
    ...
    this.canvas.className = "gameControl";
...
CanvasDisplay.prototype.clear = function() {
    box.value = null;
    let gameControls = document.getElementsByClassName("gameControl");
    
    for (let i = 0; i < gameControls.length; i++) {
        gameControls[i].parentNode.removeChild(gameControls[i]);
    }
}
...
CanvasDisplay.prototype.drawPlayer = function() {
    ...
    playerImage.src = "game/hangman/img/characters/" + this.level.player + "/" + this.level.lives + ".png";
